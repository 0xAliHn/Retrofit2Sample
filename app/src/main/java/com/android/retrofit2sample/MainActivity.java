...
public class MainActivity extends AppCompatActivity {
    ...
    private void createGithubAPI() {
        //Note also that we need to specify a factory for deserializing the response using the Gson library
    ...
    Callback<List<GithubIssue>> issues = new Callback<List<GithubIssue>>() {
        ...
        public void onResponse(Call<List<GithubIssue>> call, Response<List<GithubIssue>> response) {
            if (response.isSuccessful()) {
                ...
                ArrayAdapter<GithubIssue> spinnerAdapter = new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_spinner_dropdown_item, idArray);
